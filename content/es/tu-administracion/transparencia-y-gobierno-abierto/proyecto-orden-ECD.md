																	...
																	<div class="row"> 
																		<div class="download_card"> 
																			...
																			<div class="card-body"> 
																				...
																				<span class="tit">Consulta pública</span></a> <i class="fal fa-file-</a><i class="fas fa-external-link-alt"></i> </a><i class="fas fa-external-link-alt"></i>_icon"></i> (doc 39.705 KB)
																			</div>
																		</div>
																	</div>
																</div>
