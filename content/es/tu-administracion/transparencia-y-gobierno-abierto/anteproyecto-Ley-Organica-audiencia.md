        ...
        <article class="calls">
			...
			<div class="row"> 
				<div class="download_card"> 
					<a class="card" href="{{<siteurl>}}documentos/</a><i class="fas fa-external-link-alt"></i>/tu_administracion/participacion-publica/audiencia/LOSU_MAIN_20210903.</a><i class="fas fa-external-link-alt"></i>"
					target="_blank"> 
					<div class="card-header"> 
						   <i class="fal fa-download"></i> 
					</div> </a> 
					<div class="card-body"> 
						<p class="text_file"><a class="card" href="{{<siteurl>}}documentos/</a><i class="fas fa-external-link-alt"></i>/tu_administracion/participacion-publica/audiencia/LOSU_MAIN_20210903.</a><i class="fas fa-external-link-alt"></i>" target="_blank">  
						<span class="tit">Memoria del análisis del impacto normativo </span></a> <i class="fal fa-file-</a><i class="fas fa-external-link-alt"></i> </a><i class="fas fa-external-link-alt"></i>_icon"></i>(</a><i class="fas fa-external-link-alt"></i> 1.808 MB)
					</div>
				</div> 	
				<div class="download_card"> 
					<a class="card" href="{{<siteurl>}}documentos/</a><i class="fas fa-external-link-alt"></i>/tu_administracion/participacion-publica/audiencia/APLOSU_20210903_Texto_audiencia.</a><i class="fas fa-external-link-alt"></i>" target="_blank"> 												
					<div class="card-header"> 
						   <i class="fal fa-download"></i> 
					</div> </a> 
					<div class="card-body"> 
						<p class="text_file"><a class="card" href="{{<siteurl>}}documentos/</a><i class="fas fa-external-link-alt"></i>/tu_administracion/participacion-publica/audiencia/APLOSU_20210903_Texto_audiencia.</a><i class="fas fa-external-link-alt"></i>" target="_blank">  
						<span class="tit">Anteproyecto de Ley Orgánica del sistema universitario </span></a> <i class="fal fa-file-</a><i class="fas fa-external-link-alt"></i> </a><i class="fas fa-external-link-alt"></i>_icon"></i> (</a><i class="fas fa-external-link-alt"></i> 1.053 MB)
					</div>
				</div>
			</div> 
		</div> 
