...
weight: 3
---
## Legalización de documentos académicos universitarios oficiales que han de surtir efectos en el extranjero<br><br>
		...
		<div class="col-lg-12 cards_download_cnt">  
			<div class="row"> 
				<div class="download_card"> 
					<a class="card" href="{{<siteurl>}}/documentos/PDF/sistema_universitario/gestion_titulos/otros_procedimientos/2018-legalizaciones-solicitud.pdf" target="_blank"> 
					...
					<div class="card-body"> 
						...
						<span class="tit">Formulario de solicitud</span></a> <i class="fal fa-file-pdf pdf_icon"></i> (pdf 151.43 KB)
					</div>
				</div> 		
			</div> 
		</div> 
		...
		<div class="col-lg-12 cards_download_cnt">  
			<div class="row"> 
				<div class="download_card"> 
					...
					<div class="card-body"> 
						<p class="text_file"><a class="card" href="{{<siteurl>}}documentos/PDF/sistema_universitario/gestion_titulos/otros_procedimientos/2018-legalizaciones-solicitud.pdf" target="_blank">  
						<span class="tit">Formulario solicitud reconocimiento de firmas</span></a> <i class="fal fa-file-pdf pdf_icon"></i> (pdf 151.43 KB)
					</div>
				</div> 		
			</div> 
		</div> 
